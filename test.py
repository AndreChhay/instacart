...
#Réaliser pour chaque une liste de liste de chaque catégorie de produit acheté par client
#initialisation d'une liste vide

#Création d'un fichier data avec l'échantillon de clients
data = pd.read_csv("/Users/Ricou/Desktop/ANDRE/machine_learning/instacart/instacart-market-basket-analysis/merged-sample.csv")
...
for client in data.groupby("user_id"):
    ...
    for order in client_data.groupby("order_id"):
        ...
        #print(client_id, order_id, department_ids)
...
#List unique values in the df_products['department_id'] column
...
#Padding des Liste
#padding realise apres. rempli de 0 les séquences < seq_categorie
#truncating pre: pour les plus longues. on supprime le début
